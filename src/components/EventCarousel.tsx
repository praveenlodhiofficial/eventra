         ...
         >
            {events.map((event) => (
               <SwiperSlide key={event.id}>
                  <div className="flex h-full w-full overflow-hidden rounded-2xl bg-gradient-to-r from-gray-50 to-pink-50 shadow-2xl">
                     {/* Left Panel - Event Information */}
                     <div className="flex flex-1 flex-col justify-center space-y-6 p-8">
                        {/* Date and Time */}
                        ...
                        {/* Location */}
                        <div className="text-lg text-gray-700">{event.location}</div>
                        ...
                        <Link
                           ...
                           className="inline-block w-fit rounded-lg bg-black px-6 py-3 font-medium text-white transition-colors hover:bg-gray-800"
                        >
                           Book tickets
                        </Link>
                     </div>
                     ...
                     <div className="relative flex-1">
                        ...
                        {/* Image Overlay Text */}
                        <div className="bg-opacity-20 absolute inset-0 flex flex-col justify-between bg-black p-6">
