...
export default async function EventDetailsPage({ params }: { params: Promise<{ slug: string }> }) {
   ...
   return (
      <EventGradientBackground coverImageUrl={event?.coverImageUrl || undefined}>
         <div className="z-10 mt-15 grid grid-cols-1 gap-5 rounded-2xl p-3 text-[15px] md:p-5 lg:grid-cols-[1.8fr_1fr] lg:gap-10 lg:p-10">
                        ...
                        {event.contributors.map((contributor) => (
                           ...
                           >
                              ...
                              >
                                 ...
                                 <p className="text-[13px] text-gray-500/85">
            ...
            <div className="sticky top-25 hidden h-fit space-y-4 overflow-hidden rounded-2xl border bg-white p-4 lg:block">
               ...
               <div className="flex items-center justify-between gap-5">
                  ...
                  <Link
                     href={`/events/${slug}/book-tickets`}
                     className="font-exo2 flex h-11 cursor-pointer items-center gap-2 rounded-sm border bg-gray-100 px-3 py-1 text-xl font-bold tracking-tight uppercase invert"
                  >
                     Book tickets
                  </Link>
               </div>
