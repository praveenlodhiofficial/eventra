...
export default async function EventPage({
  ...
  return (
    <div>
      <section className="relative mx-auto mt-5 aspect-video w-full max-w-[calc(100%-2rem)] overflow-hidden rounded-t-xl md:rounded-t-2xl lg:aspect-16/7 lg:rounded-t-3xl">
        <Image
        ...
        <div className="absolute top-3 right-3 flex flex-col items-end gap-2 md:flex-row md:items-center">
          <Link href="#" key={event.id}>
            <ActionButton2
              className="flex h-8 items-center rounded-full capitalize md:text-lg"
              variant="outline"
            >
              <div className="mr-3 size-2 animate-pulse rounded-full bg-green-600" />
              <span>Active</span>
            </ActionButton2>
          </Link>
          <ActionButton2
